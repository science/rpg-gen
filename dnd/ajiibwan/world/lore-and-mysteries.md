# Deserts of Ajiibwan — Lore, Cosmology & Open Mysteries

A reference for the new campaign, synthesized from prior-play extraction notes
(world lore, open threads, and the play-history timeline). Names and spellings are
...
The setting rests on a single buried catastrophe: an ancient war between the
**Bokkaran** civilization and the **Ukar** (Titans), which created the Great
Ajiibwan Desert and cursed all arcane magic in the region.

### The Bokkaran
An advanced ancient civilization that wielded magic "not sourced from Divine or
Primal energies." They had dominion over nature and magical technology, building
towers, portals, power plants, spell engines, language engines, weapons, and entire
underground cities across Ajiibwan. They created the **storm orchids (Alorix)**,
developed the written and spoken **Bokkaran** language (still partly learnable, but
dangerous and unstable), and maintained a pantheon (Tanil, Imroth, others). The
civilization is now largely extinct/collapsed — but surviving **Bokkaran underground
...
into the **Elgar** — light-using **Wizards** who practiced harmony with nature — and the
**Polgar** — dark-using **Necromancers** who sought control over death and chaos magic to
increase their power (*Lore - Ajiibwan Wilderlands*, "Bokkaran" section). The Polgar's
...
Tugari chiefs and the Empire's ancient rulers beneath a rare celestial alignment both
cultures call the **"Night of the Compass Stars"** (*Lore - Ajiibwan Wilderlands*). The
Tugari, "spirits of the sand," claimed the night and open desert and swore never to
covet the Empire's stone and ore; the Empire recognized the dunes as sovereign Tugari
territory. The pact still constrains both powers today — relevant to any adventure that
crosses Saragubi/Granite borders or involves Tugari sovereignty.

---

## Deities, Fey & Powers

Compact entries for the divine and fey powers still reachable in the world. The
**Bokkaran pantheon remains partially active** — its gods still grant boons to those
who seek them out.

- **Tanil** — *Bokkaran Fey of the Wild*; archfey goddess of wild magic.
  Tenets: prevent human encroachment on nature, be good, protect vulnerable
  travelers. Represented by **dryads**; her sacred sites (the **Glade of Tanil**,
...
- **Imroth** — *Bokkaran God of Performances*; deity of music, art, and expression.
  Maintains presence at altars (e.g. the **Altar of Lore** in the Saragubi Crypt) and
  in an underground temple/workshop. Grants boons (e.g. **Second Sight / Secondhand
  Sight**), fine Bokkaran musical instruments, and challenges (a DC 15 performance check
...
## The Magic System in Lore

### Why arcane magic is cursed
In the regions scarred by the Bokkaran–Ukar war, casting from the **Sorcerer, Warlock,
or Wizard** traditions triggers **magical consequences** — random, dangerous magical
backlash when a spell is cast outside safe parameters. The danger is severe enough that
...
Cursed books cause possession, shadow-transformation, and madness; shrine rooms inflict
disturbance on approach; improperly conducted rituals trigger backlash. The world seems
to enforce magical boundaries with punitive mechanisms.

### The Bokkaran path to power
Arcane power is reclaimed by learning the ancient ways rather than by the standard
classes. One becomes a **Bokkaran spellcaster** by training under another Bokkaran
wizard, deeply studying Bokkaran texts, or taking a **warlock pact** (e.g. with Tanil).
It requires learning to read, write, and speak **Bokkaran**. Spell slots are acquired
via **magical engines**, multiclassing (Artificer/Sorcerer), or years of study. Spells
must be found in books, studied (8+ hours, DC 15), and memorized before casting;
learning to *write* Bokkaran requires three filled spell slots.
*(Reference only — full mechanics live elsewhere.)*

### The Ukar path to power
A parallel, less-documented tradition: learn the **Ukar** language, study Ukar texts,
and use **magical engines** that grant random spell slots — a progression mirroring the
Bokkaran route. Ukar magic skews **elemental**. Titans bond **Khezurai rings**
(elemental rings infused at maturity); scattered Ukar **elemental runes** can be bound
to an element by ritual.

### Bokkaran magical technology
The Bokkaran built sophisticated engines and power plants: **Whistling Towers**
(wind-powered generator that recovers spell slots and grants cantrips through
performance), **The Disk** (engine-powered portal), the **Charnel Keep** power plant
(maintained protective safeties; disabled = chaos), and the **Sea of Souls** engine
room (controls water flow/restoration). The **ley-line network** can be manipulated
...
## Open Mysteries & Live Threads

Unresolved questions and dangling hooks for the new party. Each gives the mystery, what
is known, and where a new party can grab hold.
...
- **Hooks:** A surviving leadership cell; the cult mole inside Hothme; the **Cult
  Leader's Fire Incident** — an old crime whose details are known to the leader's
  ex-lover **Jael Hacinth**, leverage if she can be found.
...
- **Kalinore & Ilymna:** A legendary Bokkaran romance — the wizard **Kalinore** built a
  ...
  destruction. What truly happened between them remains a mystery; both ghosts persist.
- **Slave network remnants:** **Gala dak**'s ring was broken and he held leverage over
  Governor **Kilmah Fari**, but his allies survive as an ongoing threat.
- **Holy Cities politics:** A three-way factional struggle (reformist priests under
  **Brother Eamon al-Sabir**; merchants under **Youssef al-Salim**; aristocrats under
  **Lady Fatima Zaman**) plus recovered **extortion notes** — political leverage not yet
  fully cashed in.

---

## Prior Campaign Timeline

A tight ordered summary of the previous run, by in-world **Day**. Used here as
backstory the new party inherits, not a script.

### Chapter 1 — Tel A'bib & the desert (Days 1–26)
- **Day 1** — Merchant **Feltan** hires the party to investigate a lost caravan.
- **Day 2** — First **zebra people** clash on the road to Braf/Oasis; a medallion is
  recovered; local children harvest fire-beetle oil.
- **Day 4** — A buried **glass sphere** yields a Bokkaran tome; recovering it triggers
  the first **crystal construct** attack (white-metal swords, crystal "brains").
- **Day 5** — Tracking the missing boy **Raffin**, the party finds the mysterious
  **120-ft tower at Wadi** and fights a chest construct.
- **Day 6** — Rescue of children (and **Essen's brother Tane**) from the **Eye of
  Kings** tomb; the **Cult of Anauld** is cleared.
- **Day 7** — Plateau battle with zebra people; captive **Jundard** reveals Black Water
  Cult structure (Chazim, ~1000 members, Saragubi outpost).
- **Days 8–9** — **Sphinx** excavation at the **Oasis of Sia**; massive treasure hoard;
  deal struck with **Elmingwed**; pre-dawn **assault on the Black Water Cult camp**
  (Br. Hida escapes).
- **Days 10–11** — Boar battle near the Great Oasis; Black Water ambush on the road to
  the Eye of Kings.
- **Days 12–14** — Phantom singing a Bokkaran melody leads to a Temple of Dorne; the
  **Forsaken Pyramid** necromantic site; the party learns Bokkaran via a stone artifact.
...
- **Days 23–25** — Floating magical lights; the party **frees 11 enslaved people** from
  ...
  complicity; **Serinde** reveals a spell-engine location; **B'rath** sends a gift.
- **Day 26** — **Glade of Tanil**: guardian battle, dryads, and conversions to **Tanil**
  (A''ki, Kai, Silverin, Arry); four members gain **warlock pact** abilities.

### Chapter 2 — Kalinore's Chaos / Saragubi (Days ~32–68)
- **Day 32** — Lore of the Bokkaran–Ukar poisoning surfaces (both sides want the land
  restored).
- **Day 37** — Return to the Forsaken Pyramid; finds include a giant-sized Bokkaran ring
  and a truth-compelling necklace.
...
- **Day 52** — **Afra's Tomb**: Ukar gifts distributed (seeds, tools, wand, wood
  artifact); the **Spinosaurus** relocated; the librarian-robot **Ninla** joins.
- **Days 61–68** — **Charnel Keep**: Maghiel's base, with a Bokkaran power plant and
  unseen-water engine; largely cleared. (Tied to **Kalinore's** release, the magical
  storms, and the **Rift Bridge** destruction that disrupted Saragubi trade.)

### Chapter 3 — Diplomatic Mission to the Holy Cities (Days 69–76)
- **Day 70** — Combat with the Black Water Cult yields **extortion notes** (political
  leverage).
- **Day 71** — High-society **gala** at Ell Bastis; meets **Count Iskandar Khiray** (of
  **Khiraz**), art collector Nassa Yahya, and others; intelligence gathered.
- **Days 72–73** — Discovery and prevention of the cult's city-wide **well-poisoning**
  campaign (Ell Bastis, Birjanl); antidote work.
...
- **Days 83–85** — Ukar **elemental rune** earned; **Ukar chain weapon** won in a
  ...
  to free petrified statues; **Onsun Tugari** allies with the party.
- **Days 86–88** — **Crypt of Shadows**: Skull Lord's bone staff, Bokkaran tapestries,
  fluxing (unseen) water, lens holder secured.
- **Days 91–96** — Resupply at the Bokkaran cities (focuses, timers, lanterns, amulets);
  Bokkaran dock/warehouse finds (**Ebony Nightshade Pendant**, **Starlight Sand Timer**).
- **Days 92–94** — Inhabited **Bokkaran underground cities**; A''ki wins **Eternal
  Resolve** from **Geron**.
- **Day 95** — Anti-magic field installed in a ring thrower; **Breastplate of the
  Damned** researched.
- **Days 97–99** — **Dream Catcher** recovered; preparations to use it against the
